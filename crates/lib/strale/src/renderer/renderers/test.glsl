...
// MATERIAL
int material_diffuse = 1;
int material_metal = 2;
...
Sphere sceneList[] = Sphere[84](
    ...
    Sphere(vec3( 2.287131, 0.200000, 8.583242), 0.200000, 2, vec3( 0.000000, 0.000000, 0.000000)),
    Sphere(vec3( 4.329136, 0.200000, -7.497218), 0.200000, 0, vec3( 0.030865, 0.071452, 0.016051)),
    Sphere(vec3( 4.502115, 0.200000, -5.941060), 0.200000, 2, vec3( 0.000000, 0.000000, 0.000000)),
    ...
    Sphere(vec3( 0.000000, 1.000000, 0.000000), 1.000000, 2, vec3( 0.000000, 0.000000, 0.000000)),
...
void main()
{
    ...
    Sphere spheres[] = Sphere[](
        Sphere(vec3(-1.0, 0.0, -1.0), 0.5, vec3(0.0, 0.0, 0.0), 2),
        Sphere(vec3(0.0, -1000.5, -1.0), 1000.0, vec3(0.0, 0.0, 0.0), 1)
    );
